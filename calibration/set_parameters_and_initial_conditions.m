...
load('../data/calibration/2010Q1-2019Q4.mat','calibration_data');

% Load time series data
load('../data/data/1996Q1-2019Q4.mat','data');
load('../data/ea/1996Q1-2019Q4.mat','ea');
...
for calibration_date=start_calibration_date:calquarters:end_calibration_date
    ...
    % HERE you can scale down the model for faster calculation
    scale=1/10000;
    omega=0.85;
    ...
    % Sector parameters, paper p. 11, and for a whole description Appendix
    % D
    I_s=firms;
